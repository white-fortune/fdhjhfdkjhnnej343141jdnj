			...
			">
				...
				<div className="metadata w-[75%] flex flex-col min-h-[310px]">
					...
					<div className="post-data min-h-[250px] flex flex-col">
						...
						<div className="interactive-content mt-[5px] mb-[5px] max-h-[300px] overflow-hidden flex justify-center items-center">
							{ media && <div className="img">
								<img
									src="https://placehold.co/600x400/orange/white?text=A Test"
				...
				<div className="right-side w-[10%] max-h-[300px]">
					<div className="close-button h-[20%] min-[2000px]:h-[22%] flex justify-center items-center" onClick={() => setOpen(false)}>
						<svg width="24" height="24" viewBox="0 0 24 24" className='fill-[#D9D9D9] hover:fill-gray-400 cursor-pointer' xmlns="http://www.w3.org/2000/svg">
