		...
		">
			...
			">
				<div className="left-side w-[15%]">
					<div className="author-profile-pic h-[25%] flex justify-center items-center">
				...
				<div className="metadata w-[75%] flex flex-col">
					<div className="author-section h-[18%] flex items-center">
						<div className="author-fullname">
							<span className='text-base min-[2000px]:text-[18px]'>Anirban Biswas</span>
						</div>
					</div>
					<div className="post-data h-[82%] flex flex-col">
						<div className="post-title-input w-full h-[20%]">
						...
						">
							<textarea
								className="w-full resize-none outline-none bg-transparent min-[2000px]:text-[18px]"
								placeholder="What are you working on, Anirban Biswas?"
							/>
						</div>
					</div>
				</div>

				<div className="right-side w-[10%]">
					<div className="close-button h-[20%] flex justify-center items-center" onClick={() => setOpen(false)}>
			...
			<PostSectionTools extendedClass='p-5 w-full flex justify-between h-[20%]' inAction={true} />
		</div>
	)
}
